...
import com.example.kotlinuts.R
import com.example.kotlinuts.databinding.FragmentSkillBinding
import com.example.kotlinuts.databinding.FragmentSkillItemBinding
import com.example.kotlinuts.ui.skill.SkillViewModel
    ...
    private fun filterList(query: String?) {
        ...
        if (query != null) {
            ...
            if (filteredList.isEmpty()) {
                Toast.makeText(getActivity(),"Data yang dicari tidak ditemukan",Toast.LENGTH_SHORT).show()
            } else {
